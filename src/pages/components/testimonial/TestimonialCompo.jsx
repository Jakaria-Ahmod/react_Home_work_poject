    ...
    <div>
      <div className="bg-primary1">
        <div className="flex items-center justify-center pb-[100px]">
          <div>
            <div className="flex items-center justify-center gap-x-3.5 mb-8">
            ...
            <h2 className="text-center font-Roboto_Condensed text-[48px] sm:text-[72px] md:text-[96px] font-bold leading-[101px] text-white mb-4">
              TV Commercial
            </h2>

            <p className="text-white font-Roboto_Condensed font-bold text-[14px] uppercase text-center mt-4">
              Commercials
            </p>
          </div>
        </div>
      ...
      <div className="bg-primary3 pb-[100px] pt-[100px]">
        <section className="container">
          <div>
            <div className="w-full md:max-w-[100%] h-[658px] rounded-[5px] overflow-hidden">
              <iframe
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2  gap-[50px] pt-[100px] pb-[100px]">
              <div>
                ...
                <h3 className="text-white font-Roboto_Condensed text-[36px] sm:text-[48px] md:text-[71px] leading-[72px] font-black">
                  TV Commercials are Typically Short, so it's Important
                </h3>
                <h4 className="text-primary4 font-Roboto_Condensed font-bold text-[18px] sm:text-[24px] leading-[30px] mt-[30px] mb-[30px]">
                  Focus on the most important details about your portfolio and
              ...
              <div className="sm:w-[570px] lg:w-[500px] h-[524px] rounded-[5px] overflow-hidden">
                <img
                  src={img}
                  alt="img"
                  className="w-full h-full object-cover"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[50px] pt-[100px] pb-[100px]">
              <div className="w-full sm:w-[570px] h-[524px] rounded-[5px] overflow-hidden">
                <img
                  src={img}
                  alt="img"
                  className="w-full h-full object-cover"
            ...
            <div className="pt-[100px] pb-[100px]">
              <div>
                ...
                <div className="relative hidden lg:block">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-[30px] absolute top-[-150px] w-full sm:w-[1070px] p-[50px] bg-[#11121E] rounded-[3px]">
                    <div>
                      <div className="flex items-center gap-x-3.5">
                        <div className="w-[40px] h-[1px] bg-primary2"></div>
                        <div>
                      ...
                      <h3 className="font-Roboto_Condensed text-[36px] sm:text-[48px] md:text-[65px] font-bold leading-[72px] text-white">
                        Tailor the Message to Your Target Audience
                      </h3>
                    </div>
                    <div className="w-full sm:w-[441px]">
                      <p className="font-Roboto_Condensed text-[18px] sm:text-[24px] font-bold text-white leading-[30px]">
                        Consider who your target audience is and tailor your
                        message accordingly.
                      </p>
                      <p className="font-Inter text-base font-normal leading-[24px] text-[#82869A] mt-[20px]">
            ...
            <div className="pt-[100px] sm:pt-[200px]">
              <div>
                <div className="flex justify-between mb-[50px]">
                  <div>
                    ...
                    <h4 className="text-[36px] sm:text-[48px] md:text-[72px] font-bold leading-[72px] font-Roboto_Condensed text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[30px] mt-[50px] rounded-[5px] overflow-hidden">
                  ...
                  <div key={index}>
                    ...
                    <div className="relative">
                      <div className="px-[5px] bg-[gray] w-full absolute top-[-100px] pl-[30px] py-[20px]">
                        <p className="text-[20px] sm:text-[36px] font-bold leading-[40px] font-Roboto_Condensed text-white">
                          {item.movieName}
                        </p>
