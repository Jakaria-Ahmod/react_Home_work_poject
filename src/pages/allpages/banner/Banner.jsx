...
const Banner = () => {
  return (
    <div>
      <div className="bg-primary1 pb-[20px] md:pb-[100px] lg:pb-[244px]">
        <section className="container md:pt-[70px] mt:[20px]">
          <div className="md:w-[770px]">
            ...
            <h1 className="lg:text-[96px] font-Roboto_Condensed md:leading-[101px] md:text-[40px] text-[22px] text-white font-bold">
