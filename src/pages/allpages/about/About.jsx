...
import aboutImg from '../../../assets/img/aboutimg.jpg';
import aboutshep from '../../../assets/img/aboutimgshep.png';
import { motion } from 'framer-motion'; // সংশোধিত import path

const About = () => {
  return (
    <div className="bg-primary3 overflow-hidden">
      <div className="pt-[50px] sm:pt-[80px] md:pt-[100px] pb-[50px] sm:pb-[80px] md:pb-[94px]">
        <section className="container px-4 sm:px-6 lg:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] sm:gap-[40px] lg:gap-[50px] items-center">
            {/* Left Section */}
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <div className="flex items-center gap-x-3 mb-[16px] sm:mb-[24px]">
                <div className="w-[30px] sm:w-[40px] h-[1px] bg-primary2"></div>
                <span className="text-primary2 font-Roboto_Condensed text-[12px] sm:text-[14px] uppercase">
                  About Us
                </span>
              ...
              <h2 className="font-Roboto_Condensed text-[28px] sm:text-[48px] lg:text-[64px] leading-[36px] sm:leading-[56px] lg:leading-[72px] text-white font-bold mb-[16px] sm:mb-[24px]">
                We Are a Team of Passionate Filmmakers
              </h2>

              <strong className="block font-Roboto_Condensed text-[14px] sm:text-[18px] lg:text-[20px] font-bold text-[#82869A] leading-[22px] sm:leading-[28px] mb-[20px] sm:mb-[30px]">
                Dedicated to bringing creative and compelling stories to life on
                screen
              </strong>

              <div className="relative">
                <div className="absolute bottom-[-120px] sm:bottom-[-180px] right-[-100px] sm:right-[-220px] z-10 hidden md:block">
                  <img src={aboutshep} alt="Shepherd" />
                </div>
              </div>

              <p className="font-Inter text-[14px] sm:text-[16px] font-normal leading-[22px] sm:leading-[26px] text-[#82869A] max-w-full sm:max-w-[500px] mb-[20px] sm:mb-[30px]">
                Proin et magna blandit arcu pellentesque scelerisque sit amet a
                sapien. Aenean purus nunc, cursus in ante in, vehicula facilisis
                dui. Integer consequat consectetur est id blandit.
              </p>

              <button className="py-[10px] sm:py-[14px] px-[18px] sm:px-[25px] bg-primary2 text-white text-[12px] sm:text-[14px] font-bold uppercase font-Roboto_Condensed">
                Learn More
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
              className="relative w-full h-[280px] sm:h-[400px] md:h-[500px] lg:h-[700px] rounded-[5px] overflow-hidden"
            >
              <img
                src={aboutImg}
                alt="Filmmakers"
