...
const Nav = () => {
  ...
  return (
    <div className="bg-primary1 pb-[60px] md:pb-[100px]">
      <div className="container px-4 md:px-0">
        ...
        <header className="flex flex-col md:flex-row items-center justify-between gap-y-6 py-6">
          ...
          <div className="flex items-center gap-x-4 order-2 md:order-1">
            ...
            <IoLogoTwitter color="white" size={18} className="cursor-pointer" />
        ...
        <nav className="relative">
          ...
          <ul
            ...
            } md:flex border-t md:border-t-0 border-[#989AA9] pt-4 md:pt-0`}
          >
